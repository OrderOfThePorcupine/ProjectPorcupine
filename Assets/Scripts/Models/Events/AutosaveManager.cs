...
public class AutosaveManager
{
    ...
    public AutosaveManager()
    {
        ...
        {
            string[] autosaveFileNames = Directory.GetFiles(GameController.FileSaveBasePath, AutosaveBaseName + "*.sav");
    ...
    public void DoAutosave(ScheduledEvent evt)
    {
        ...
        GameController.Instance.CurrentSystem.SaveWorld(filePath);
    }
